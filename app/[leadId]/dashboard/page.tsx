    ...
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <aside className={`
          ...
          md:relative md:translate-x-0 md:w-64 md:h-full
          ...
          {activeTab !== "messages" && (
            <header className="flex justify-between items-center mb-8 shrink-0">
              <div className="min-w-0">
                <h1 className="text-xl md:text-2xl font-bold text-gray-800 truncate">Dashboard Overview</h1>
                <p className="text-gray-500 text-xs md:text-sm truncate">Tracking your project progress with us.</p>
              </div>
            </header>
          )}
