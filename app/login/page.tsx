    ...
    <div className="min-h-screen flex font-sans bg-base-100 overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white relative">
        ...
        >
          ...
          >
            <div className="w-24 h-24 rounded-3xl bg-white shadow-xl shadow-indigo-100 flex items-center justify-center border border-indigo-50 p-4">
              <Image 
                src="/logo.png" 
                alt="Logo" 
                width={80} 
...
All activites are securely logged and monitered          </motion.p>
        </motion.div>
      </div>
    </div>
  );
